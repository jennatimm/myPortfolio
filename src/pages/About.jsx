    ...
    return (
        <div class="page">
            ...
            <div className="p-2">
                ...
                <TextBox text="But it wasn’t until I discovered coding that everything truly clicked. Coding 
                allowed me to take those complex ideas and bring them to life in an interactive way. It was 
                ...
                abilities under the guidance of experienced professionals. I look forward to collaborating 
                with others, learning from their expertise, and contributing my own passion and perspective 
