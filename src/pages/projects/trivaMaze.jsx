...
import exOne from '../../media/trivamaze/startingLosingPlay.gif';
import exTwo from '../../media/trivamaze/winningPlay.gif';
import profile from '../../media/trivamaze/profile.png';

 export const TrivaMaze = () => {
    return (<div className="page">

        <Banner text="TRIVA MAZE" image={profile}/>
