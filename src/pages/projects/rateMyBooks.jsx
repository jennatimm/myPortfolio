...
export const RateMyBooks = () => {
    return (<div className="page">
        ...
        <div className="page pt-20 z-5">
            ...
            text2="The goal was to simulate real-world development conditions. Frontend and 
            ...
            text2="To contribute meaningfully, I focused on fully understanding my section rather than the 
            ...
            <ImgTextCard title="~ Backend Development ~" 
            ...
            <ImgTextCard title="~ Frontend Development ~" 
            ...
            text2="Equally important, I learned to adapt my learning style. I developed the ability to navigate ambiguous 
